...
// Fetch the data
    ...
    $query = "SELECT dates, AVG(value) as valor FROM temperaturesoil WHERE pan = ". $pandlet ." AND farm = " . $farm . " GROUP BY dates ORDER BY dates ASC";
  ...
  // Print out rows - date + Temperature
    ...
    while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
      ...
      echo $prefix . " {\n";
      echo '  "date": "' . $date . '",' . "\n";
      echo '  "soiltemperature": ' . $row['valor'] . '' . "\n";
      echo " }";
      $prefix = ",\n";
    }
    echo "\n]";
