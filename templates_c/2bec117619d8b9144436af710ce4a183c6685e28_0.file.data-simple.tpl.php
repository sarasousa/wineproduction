<?php /* Smarty version 3.1.27, created on 2016-02-04 12:33:42
         compiled from "/usr/users2/mieec2012/ee12001/public_html/SETEC/templates/data-simple.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:101503430156b337168047b4_13423805%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2bec117619d8b9144436af710ce4a183c6685e28' => 
    array (
      0 => '/usr/users2/mieec2012/ee12001/public_html/SETEC/templates/data-simple.tpl',
      1 => 1454585581,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '101503430156b337168047b4_13423805',
  'variables' => 
  array (
    'pandlet' => 0,
    'farm' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_56b33716991520_29547213',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_56b33716991520_29547213')) {
function content_56b33716991520_29547213 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '101503430156b337168047b4_13423805';
...
<button type="submit" class="btn-switch" onclick="window.location.href='../php/data-pandlet-advanced.php?pandlet=<?php echo $_smarty_tpl->tpl_vars['pandlet']->value;?>
&farm=<?php echo $_smarty_tpl->tpl_vars['farm']->value;?>
'"><span>Switch to Advanced Mode</span></button> 
                      ...
                      <div class="col-md-6">
                        <div class="card data">
                            <div class="header">
                                ...
                                <p class="category">Pandlet <?php echo $_smarty_tpl->tpl_vars['pandlet']->value;?>
 </p>
                            </div>
...
>
        <?php echo '<script'; ?>
 src="../js/selectFx.js"><?php echo '</script'; ?>
>
            ...
            function run(element) {
                    ...
                    for (k = 0; k < s_data.length; k++)
                    {
                      ...
                      if (j==0)
                        ...
                        {
                            $(element).parent().parent().parent().siblings().filter('.status-text').text('The ' + $(element).attr('measures') + ' in the zone around Pandlet <?php echo $_smarty_tpl->tpl_vars['pandlet']->value;?>
 has been ' + val + unit + ' in the last ' +  $(element).find(":selected").text() + '.');
